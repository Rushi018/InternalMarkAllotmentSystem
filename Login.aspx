<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="InternalMarkAllotmentSystem.Login" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1 class="text-center text-danger">Student Login</h1>
